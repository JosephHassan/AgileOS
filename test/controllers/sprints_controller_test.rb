...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { Release_id: @sprint.Release_id, description: @sprint.description, end_date: @sprint.end_date, start_date: @sprint.start_date, title: @sprint.title }
    end
  ...
  test "should update sprint" do
    patch :update, id: @sprint, sprint: { Release_id: @sprint.Release_id, description: @sprint.description, end_date: @sprint.end_date, start_date: @sprint.start_date, title: @sprint.title }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
